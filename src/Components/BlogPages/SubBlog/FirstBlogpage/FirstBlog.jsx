        ...
        <>
            ...
            <Row
                ...
                <Col md={7} className="d-flex flex-column align-items-center py-5 justify-content-center">
                     <div>
                        <div>
                            <h3 className="text-secondary fw-bold text-center">Visual Impact</h3>
                            <p className="fs-6 text-muted text-justify">
                    ...
                    <div className="px-0 ">
                        <div
                            className="py-5 ">
                            <h3 className="text-secondary fw-bold text-center">
                ...
                <h3 className="text-center text-secondary">Other Blogs</h3>
                <ul>
