...
export default function Banner(){
    return(
        ...
        <div className='w-50 py-2 px-5 d-md-flex align-items-center justify-content-center rounded-5 font-bold'  style={{background: 'linear-gradient(to bottom, #4ECFFF, #3B7FBF)'}}>
        ...
        <div className='w-50 font-medium py-3'>
        <p className='para text-black'>Avail high-end ,yet cost effectivve cakePHP Development
