                ...
                <Col md={10}>
                    <Accordion defaultActiveKey="0" className='main-accrodinstart'>
                        <Accordion.Item eventKey='0' className='main-accrodinstartItem  my-2'>
                            ...
                            <div>
                            <ul className='unorderlistCar'>
                            <li><MdKeyboardDoubleArrowRight />Minimum of 5 years of proven experience as an SEO Specialist.</li>
                            <li><MdKeyboardDoubleArrowRight />In-depth knowledge of SEO tools, Google Analytics, Search Console, GMT, and industry trends.</li>
                            <li><MdKeyboardDoubleArrowRight />Proficiency in implementing on-page and off-page SEO best practices.</li>
                            <li><MdKeyboardDoubleArrowRight />Strong analytical and problem-solving skills.</li>
                            <li><MdKeyboardDoubleArrowRight />Excellent communication and collaboration skills.</li>
                            <li><MdKeyboardDoubleArrowRight />Ability to adapt to evolving SEO algorithms and industry changes</li>
                            </ul>
                            </div>
                            </Accordion.Body>
