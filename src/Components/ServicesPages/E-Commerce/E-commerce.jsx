        ...
        <>
                   ...
                   >
                    <Col md className='px-0 d-md-flex flex-col justify-content-center align-items-center'>
                        ...
                        <div className='d-md-flex justify-content-center align-items-center gap-5'>
                            ...
                            <div>
                                <h2 className='hed2'>E-commerce Platform Integration</h2>
                ...
                <Row className='uppercontainer py-5'  style={{background:"linear-gradient(to bottom, rgb(59, 127, 191), #063b6d21)" }}>
                   <div className='d-md-flex justify-content-center align-items-center'>
                            ...
                            <section className='d-md-flex justify-content-center align-items-center  col-md-6'>
                                <img src="/Image/img1 (2).png" alt=""/>
                            </section>
                        </div>
                        <div className='d-md-flex justify-content-center align-items-center'>
                            <section className='d-flex justify-content-center align-items-center col-md-6'>
                                <img src="/Image/img1 (1).png" alt="" className='img-fluid' />
                            </section>
                            <section>
                                <h2 className='hed2 text-light'>Secure Payment Gateway Integration</h2>
                ...
                >
                    ...
                    <Col md={6}>
                        <h2 className='hed2'>Conversion Rate Optimization</h2>
                ...
                <Row className='justify-content-center align-items-center py-5'
                    style={{ background: "linear-gradient(to bottom,rgba(90,161,227,30%), rgba(90,161,227,10%))" }}>
                    <Col md={6}>
                        <h2 className='hed2'>Digital Marketing and SEO</h2>
                ...
                <Row className='py-5 justify-content-center' style={{ backgroundColor: "#3B7FBF" }}>
                    <Col md={10}>
                        <div className='text-center text-light '>
                            <h4>Our Ecommerce Technologies And Tools</h4>
                            <p className='fs-6'>Our team of eCommerce website developers makes the best use of the latest tools in the market to develop
                        ...
                        <Marquee>
                            <div className='d-md-flex justify-content-center align-items-center gap-5 py-3'>
                                <div>
                ...
                <Row className='my-lg-5 justify-content-center align-items-center'
                    ...
                    <Col md={5} className='py-3'>
                        <div>
                            <h3 className='text-white fw-bolder' >Bespoke E-CommerceWeb
                                Development Experiences</h3>
                            <p className='text-white para'>Reach a massive range of customers across the world by digitizing your
                ...
                >
                    <Col md={5}>
                        <div>
                            ...
                            <img src="Image/Mask group (7).png" alt="" /><span>Product Inventory</span></h6>
