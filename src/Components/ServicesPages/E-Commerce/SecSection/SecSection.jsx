            ...
            <Row className='py-lg-4 justify-content-center align-items-center'>
                <Col md={10} className='py-5 text-center' >
                    <div className='Firstsection-text'>
                        <h3 className='text-center fw-bold'>We Deliver Your Essential Ecommerce Requirement</h3>
                        <p>
                    ...
                    <div className='d-md-flex gap-[110px] justify-content-center align-items-center'>
                    <div className='d-md-flex gap-2 justify-content-center align-items-center '>
                        <img src="/Image/sec-section-2 (8).png" alt="" className='img-style-secSection img-fluid' />
                    ...
                    <div className="d-md-flex d-md-flex gap-2 justify-content-center align-items-center">
                        <img src="/Image/sec-section-2 (7).png" alt="" className='img-style-secSection img-fluid' />
                        <div className='d-flex flex-col  justify-center align-items-center'>
                    ...
                    <div className='d-md-flex gap-2 justify-content-center align-items-center'>
                        <img src="/Image/sec-section-2 (6).png" alt="" className='img-style-secSection img-fluid' />
                        <div className='d-flex flex-col align-items-center justify-content-center'>
                            <h3 className='hed3'>Third
                                Party</h3>
                            <p className='para'>Integration</p>
                        </div>
                    </div>
                    <div className='d-md-flex gap-2 justify-content-center align-items-center '>
                        <img src="/Image/sec-section-2 (5).png" alt="" className=' img-style-secSection img-fluid' />
                ...
                <div className='d-md-flex gap-3 justify-content-center align-items-center'>
                    <div className='d-md-flex gap-2 justify-content-center align-items-center w-50'>
                        <img src="/Image/Mask group (5).png" alt="" className='img-style-secSection img-fluid' />
                    ...
                    <div className='d-md-flex gap-2 justify-content-center align-items-center w-50'>
                        <img src="/Image/sec-section-2 (3).png" alt="image" className='img-style-secSection img-fluid' style={{ backgroundColor: "#3B7FBF" }} />
                        <div className=' flex flex-col  align-items-center justify-content-center'>
                            <h3 className='hed3'>Multi-Sites</h3>
                            <p className='para'>Management</p>
                        </div>
                    </div>
                    <div className='d-md-flex gap-2 justify-content-center align-items-center w-50'>
                        <img src="/Image/sec-section-2 (2).png" alt="" className='img-style-secSection img-fluid' />
                        <div className='flex flex-col align-items-center justify-content-center'>
                            <h3 className='hed3'>Payment</h3>
                            <p className='para'>Gateway
                                Integration</p>
                        </div>
                    </div>
                    <div className='d-md-flex gap-2 justify-content-center align-items-center w-50'>
                        <img src="/Image/sec-section-2 (1).png" alt="" className='img-style-secSection img-fluid' />
                        <div className='flex flex-col align-items-center justify-content-center'>
