...
export default function Android(){
    return(
        ...
        <Col md={10}>
        <div>
        <h3 className=' font-[500] hed3'>HIRE ANDROID DEVELOPERS FOR YOUR PROJECT</h3>
        <h2 className=' text-center  hed2  animate__animated animate__heartBeat '>Dedicated Android developers for Hire from a vast pool of 
        skilled technical resources with both technical and domain 
        expertise.</h2>
        </div>
        <div className='d-flex align-items-center justify-center gap-5'>
        <div>
        <h3 className='hed3 animate__animated animate__backInLeft'>"Hire Android app programmers from Hidden Brains to 
        get the best support for Android app development"</h3>
        </div>
        <div>
        
        <p className='para animate__animated animate__backInLeft'>Our team of experienced Android app developers drives value-added 
        ...
        <div>
         <p className='para text-center '>At Hidden Brains, you can hire an Android developer to build feature-rich, interactive, and secure Android applications. We help to meet your 
organizational abusiness objectives, becoming an extension of your IT business.</p>

<p className='para text-center'>Our top rated iOS developers for hire, based in our offshore software development centers in Hyderabad, Pune, Ahmedabad, Indore, India are well versed 
...
full-time, part-time or hourly basis to build secure and scalable applications for your business.</p>
        ...
        <Col md={10} >
        <h3 className='hed3 text-white text-center'>Benefits of Hiring Android App Developer From Us</h3>
        ...
        <img src="Image/Androi5 (6).png" alt="" className='img-fluid' style={{maxWidth:"100px"}} />
        ...
        <img src="Image/Androi5 (5).png" alt="" className='img-fluid ' style={{maxWidth:"100px"}} />
        ...
        <div className='php-section1'>
        <img src="Image/Androi5 (4).png" alt="" className='img-fluid ' style={{maxWidth:"100px"}} />
        ...
        <div className='php-section1'>
        <img src="Image/Androi5 (3).png" alt="" className='img-fluid' style={{maxWidth:"100px"}} />
        <h3 className='hed3 pt-2' style={{color:"#3b7fbf"}}>Android Apps Upgrade</h3>
        <p  className='para text-center pt-2' >Lorem Ipsum is simply dummy text of the 
        printing and typesetting industry.Lorem</p>
        </div>
        <div className='php-section1 '>
        <img src="Image/Androi5 (2).png" alt="" className='img-fluid ' style={{width:"100px"}} />
        ...
        <div className='php-section1'>
        <img src="Image/Androi5 (1).png" alt="" className='img-fluid ' style={{width:"100px"}} />
        ...
        <div className='d-md-flex  d-none justify-content-center align-items-center gap-5 p-3'>
        <div className='php-section1'>
        <img src="Image/Andro 6 (3).png" alt="" className='img-fluid' style={{maxWidth:"100px"}} />
        <h3 className='hed3 pt-2' style={{color:"#3b7fbf"}}>Android Apps Upgrade</h3>
        <p  className='para text-center pt-2' >Lorem Ipsum is simply dummy text of the 
        printing and typesetting industry.Lorem</p>
        </div>
        <div className='php-section1 '>
        <img src="Image/Andro 6 (2).png" alt="" className='img-fluid ' style={{width:"100px"}} />
        <h3 className='hed3  pt-2 text-center' style={{color:"#3b7fbf"}}>Android App 
        Maintenance</h3>
        <p  className='para text-center pt-2'>Lorem Ipsum is simply dummy text of the 
        printing and typesetting industry.Lorem</p>
        ...
        <div className='php-section1'>
        <img src="Image/Andro 6 (1).png" alt="" className='img-fluid ' style={{width:"100px"}} />
        <h3 className='hed3  pt-2 text-center' style={{color:"#3b7fbf"}}>Application Porting</h3>
        <p  className='para text-center pt-2'>Lorem Ipsum is simply dummy text of the 
        printing and typesetting industry.Lorem</p>
        </div>
