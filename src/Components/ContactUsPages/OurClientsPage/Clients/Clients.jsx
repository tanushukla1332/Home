...
export default function Clients(){
    return(
        ...
        <h3 className='hed3 text-center fs-6  ' style={{color:"#3b7fbf"}}>WEB-BASED APP DEVELOPMENT</h3>
        <div className='flex items-center justify-center'>
        ...
        <h3 className='hed3 text-center fs-6  ' style={{color:"#3b7fbf"}}>MOBILE APP DEVELOPMENT</h3>
        <div className='flex items-center justify-center'>
        <Button className='read-case-study'>Read-case-study <RiArrowRightDoubleLine /> </Button>
        </div>
        ...
        <h3 className='hed3 text-center fs-6  ' style={{color:"#3b7fbf"}}>CUSTOM INTEGRATIONS AND 
        ANALYTICS</h3>
        <div className='flex items-center justify-center'>
        <Button className='read-case-study'>Read-case-study <RiArrowRightDoubleLine /></Button>
        </div>
